...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "fheSDm1BkaG8b2iZkg5vwTvfRcQf9MRoBrJOeIiq";
    private static final String SECRETKEY = "KYd_RhFSsikwfTpZ5Ce2kWzBg7uRsycK3dfDphQy";
    private static final String BUCKET = "ymm01";
    public static final String DOMAIN= "http://qup16ryj9.hn-bkt.clouddn.com/";
